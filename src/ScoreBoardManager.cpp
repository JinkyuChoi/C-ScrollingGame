...
void ScoreBoardManager::Start()
{
	...
	m_pLivesLabel = new Label("Lives: 5", "PressStart2P-Regular", 20, yellow,
		glm::vec2(10.0f, 10.0f), TTF_STYLE_NORMAL, false);

	m_pScoreLabel = new Label("Score: 0", "PressStart2P-Regular", 20, yellow,
		glm::vec2(550.0f, 10.0f), TTF_STYLE_NORMAL, false);
}
